...
public class AnyApplication extends Application implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate() {
        ...
        mBottomRowFactory = new KeyboardExtensionFactory(this, R.string.settings_default_ext_kbd_bottom_row_key, R.string.settings_key_ext_kbd_bottom_row_key, KeyboardExtension.TYPE_BOTTOM);
        mTopRowFactory = new KeyboardExtensionFactory(this, R.string.settings_default_top_row_key, R.string.settings_key_ext_kbd_top_row_key, KeyboardExtension.TYPE_TOP);
        mExtensionKeyboardFactory = new KeyboardExtensionFactory(this, R.string.settings_default_ext_keyboard_key, R.string.settings_key_ext_kbd_ext_ketboard_key, KeyboardExtension.TYPE_EXTENSION);
