...
public class QuickKeysOrderedListFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAllQuickKeysAddOns = AnyApplication.getQuickTextKeyFactory(appContext).getOrderedEnabledAddOns();
    ...
    public void onStop() {
        super.onStop();
        AnyApplication.getQuickTextKeyFactory(getContext()).setOrderedEnabledIds(mEnabledAddOns);
    }
