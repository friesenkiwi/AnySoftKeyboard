...
public class KeyboardExtensionFactoryTest {
    ...
    public void testGetAllAvailableExtensions() throws Exception {
        assertBasicListDetails(AnyApplication.getBottomRowFactory(RuntimeEnvironment.application).getAllAddOns(), 7, KeyboardExtension.TYPE_BOTTOM);
        assertBasicListDetails(AnyApplication.getTopRowFactory(RuntimeEnvironment.application).getAllAddOns(), 6, KeyboardExtension.TYPE_TOP);
