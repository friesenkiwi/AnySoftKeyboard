...
public class QuickTextKeyFactoryTest {
    ...
    public void testDefaultOrder() {
        List<QuickTextKey> orderAddOns = AnyApplication.getQuickTextKeyFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns();
    ...
    public void testOrderStore() {
        ...
        AnyApplication.getQuickTextKeyFactory(RuntimeEnvironment.application).setOrderedEnabledAddOns(revisedQuickKeys);
        ...
        orderAddOns = AnyApplication.getQuickTextKeyFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns();
