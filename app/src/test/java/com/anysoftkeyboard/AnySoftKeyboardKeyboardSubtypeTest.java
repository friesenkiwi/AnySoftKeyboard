...
public class AnySoftKeyboardKeyboardSubtypeTest extends AnySoftKeyboardBaseTest {
    ...
    public void testKeyboardSwitchedOnCurrentInputMethodSubtypeChanged() {
        ...
        AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).setOrderedEnabledAddOns(AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).getAllAddOns());

        final KeyboardAddOnAndBuilder keyboardBuilder = AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns().get(1);
    ...
    public void testKeyboardDoesNotSwitchOnDelayedSubtypeReported() {
        ...
        //switching to the next keyboard
        mAnySoftKeyboardUnderTest.simulateKeyPress(KeyCodes.MODE_ALPHABET);
        final KeyboardAddOnAndBuilder keyboardBuilderOne = AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns().get(1);
        //ensuring keyboard was changed
        ...
        mAnySoftKeyboardUnderTest.simulateKeyPress(KeyCodes.MODE_ALPHABET);
        //ensuring keyboard was changed
        final KeyboardAddOnAndBuilder keyboardBuilderTwo = AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns().get(2);
    ...
    public void testKeyboardSwitchOnUserSubtypeChanged() {
        ...
        //and changing again (loop the keyboard)
        final KeyboardAddOnAndBuilder keyboardBuilderZero = AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns().get(0);
        mAnySoftKeyboardUnderTest.simulateKeyPress(KeyCodes.MODE_ALPHABET);
        //ensuring keyboard was changed
        Assert.assertSame(keyboardBuilderZero.getId(), mAnySoftKeyboardUnderTest.getCurrentKeyboardForTests().getKeyboardPrefId());
    }
    ...
    public void testKeyboardDoesSwitchWithoutSubtypeReported() {
        ...
        mAnySoftKeyboardUnderTest.simulateKeyPress(KeyCodes.MODE_ALPHABET);
        final KeyboardAddOnAndBuilder keyboardBuilderThree = AnyApplication.getKeyboardFactory(RuntimeEnvironment.application).getOrderedEnabledAddOns().get(3);
        //ensuring keyboard was changed
